...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "cvasii-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/etechn"
  #   chef.validation_client_name = "etechn-validator"
  #   chef.validation_key_path = ".chef/etechn-validator.pem"
  # end
end
